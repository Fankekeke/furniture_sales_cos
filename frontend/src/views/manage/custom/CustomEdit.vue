<template>
  <a-modal v-model="show" title="修改定制家具" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='定制家具标题' v-bind="formItemLayout">
            <a-input v-decorator="[
            'title',
        ...
        <a-col :span="12">
          <a-form-item label='定制家具状态' v-bind="formItemLayout">
            <a-select v-decorator="[
              'rackUp',
              { rules: [{ required: true, message: '请输入定制家具状态!' }] }
              ]">
        ...
        <a-col :span="24">
          <a-form-item label='定制家具内容' v-bind="formItemLayout">
